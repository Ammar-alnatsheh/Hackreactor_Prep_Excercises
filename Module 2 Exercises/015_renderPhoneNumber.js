...
var phoneNumber = new PhoneNumberFormatter([4,1,5,6,7,6,1,6,8,9]);

assertEqual(phoneNumber.render(), "(415) 676-1689", "should convert an array of numbers into a phone number format");
