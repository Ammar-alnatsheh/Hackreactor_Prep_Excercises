...
function computeCompoundInterest(principal, interestRate, compoundingFrequency, timeInYears) {
  ...
  var periodicCompounding = 1 + ( interestRate / compoundingFrequency) ;

  var compoundInterestInTime = principal * ( periodicCompounding ** (compoundingFrequency * timeInYears) ) ;

  return compoundInterestInTime - principal ;
